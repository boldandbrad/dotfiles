...
return {
  ...
  keys = {
    ...
    { "<leader>M",  "<cmd>Grapple toggle_tags<cr>",     desc = "Open tagged buffer list" },
    { "<leader>n",  "<cmd>Grapple cycle_tags next<cr>", desc = "Next tagged buffer" },
    { "<leader>p",  "<cmd>Grapple cycle_tags prev<cr>", desc = "Previous tagged buffer" },
